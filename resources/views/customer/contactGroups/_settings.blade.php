    ...
    <div class="card">
        <div class="card-body">
            <div class="col-md-7 col-12 settings">
                <form class="form form-vertical" action="{{ route('customer.contacts.update', $contact->uid) }}"
                    method="post">
                    {{ method_field('PUT') }}
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="mb-1">
                                ...
                                <input type="text" id="name"
                                    ...
                                    value="{{ $contact->name }}" name="name" required>
                                @error('name')
                                            ...
                                            <div class="input-group-text">
                                                <div class="form-check">
                                                    <input type="radio" class="form-check-input sender_id"
                                                        name="originator" checked value="sender_id" id="sender_id_check" />
                                            ...
                                            <div class="input-group-text">
                                                <div class="form-check">
                                                    <input type="radio" class="form-check-input phone_number"
                                                        value="phone_number" name="originator" id="phone_number_check" />
                                            ...
                                            <div style="width: 17rem">
                                                <select class="form-select select2" disabled id="phone_number"
                                                    ...
                                                    @foreach ($phone_numbers as $number)
                                                        <option value="{{ $number->number }}"> {{ $number->number }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            </div>
                            ...
                            {{-- <div class="col-12">
                                <div class="mb-1">
                                    ...
                                    <input type="text" id="sender_id"
                                        class="form-control @error('sender_id') is-invalid @enderror" name="sender_id">
                                    @error('sender_id')
                                        <p><small class="text-danger">{{ $message }}</small></p>
                                    @enderror
                                </div>
                        ...
                        <div class="col-2">
                            <div class="mb-1">
                                <div class="form-check form-switch form-check-primary form-switch-md">
                                    <input type="checkbox" name="send_welcome_sms" value="1"
                                        {{ $contact->send_welcome_sms == 1 ? 'checked' : null }}
                                        class="form-check-input" id="send_welcome_sms">
                            ...
                            <div class="mb-1">
                                <div class="form-check form-switch form-check-primary form-switch-md">
                                    <input type="checkbox" name="unsubscribe_notification" value="1"
                                        {{ $contact->unsubscribe_notification == 1 ? 'checked' : null }}
                                        class="form-check-input" id="unsubscribe_notification">
                    ...
                    @can('view_keywords')
                        <div class="row mt-2">
                            <div class="col-10">
                                ...
                                <p><small class="">{!! __('locale.contacts.send_keyword_message_description') !!}</small> <a href="#"
                                        class="text-danger small">{{ __('locale.menu.Keywords') }}</a></p>

                            </div>
                            <div class="col-2">
                                <div class="mb-1">
                                    <div class="form-check form-switch form-check-primary form-switch-md">
                                        <input type="checkbox" name="send_keyword_message" value="1"
                                            {{ $contact->send_keyword_message == 1 ? 'checked' : null }}
                                            class="form-check-input" id="send_keyword_message">
