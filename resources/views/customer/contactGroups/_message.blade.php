            ...
            <div class="col-md-6 col-12">
                <form class="form form-vertical" action="{{ route('customer.contacts.message', $contact->uid) }}"
                        ...
                        <div class="col-12">
                            <div class="mb-1">
                                ...
                                <select class="form-select select2" id="available_tag">
                                    ...
                                    <option value="anniversary_date">{{ __('locale.labels.anniversary_date') }}
                                    </option>
                    ...
                    <div class="show-subscribe-url">
                        <p class="m-0"><small class="text-uppercase text-primary">
                                {{ __('locale.labels.subscribe_url') }} </small></p>
                        <div class="row">
                            ...
                            <div class="col-md-2 col-sm-12">
                                <button type="button" class="btn btn-primary"
                                    id="btn-copy">{{ __('locale.buttons.copy') }}!</button>
                            </div>
                        </div>
                    </div>
