            ...
            <div class="col-12">
                ...
                <ul class="nav nav-pills mb-2 text-uppercase" role="tablist">
                    ...
                    @can('update_contact_group')
                        <li class="nav-item">
                            <a class="nav-link @if (old('tab') == 'settings' || old('tab') == null) active @endif" id="settings-tab-justified"
                    ...
                    @can('view_contact')
                        <li class="nav-item">
                            <a class="nav-link {{ old('tab') == 'contact' ? 'active' : null }}" id="contact-tab-justified"
                    ...
                    @can('update_contact_group')
                        {{-- message --}}
                        <li class="nav-item">
                            <a class="nav-link {{ old('tab') == 'message' ? 'active' : null }}" id="message-tab-justified"
                                data-bs-toggle="tab" href="#message" role="tab" aria-controls="message"
                                aria-selected="true">
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ old('tab') == 'opt_in_keywords' ? 'active' : null }}"
                                id="opt_in_keywords-tab-justified" data-bs-toggle="tab" href="#opt_in_keywords" role="tab"
                                aria-controls="opt_in_keywords" aria-selected="true">
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ old('tab') == 'opt_out_keywords' ? 'active' : null }}"
                                id="opt_out_keywords-tab-justified" data-bs-toggle="tab" href="#opt_out_keywords" role="tab"
                                aria-controls="opt_out_keywords" aria-selected="true">
                    ...
                    @can('create_contact_group')
                        <li class="nav-item">
                            <a class="nav-link {{ old('tab') == 'import_history' ? 'active' : null }}"
                                id="import-history-tab-justified" data-bs-toggle="tab" href="#import-history" role="tab"
                                aria-controls="import-history" aria-selected="true">
                ...
                <div class="tab-content pt-1">
                    @can('update_contact_group')
                        <div class="tab-pane @if (old('tab') == 'settings' || old('tab') == null) active @endif" id="settings" role="tabpanel"
                    ...
                    {{-- cotnacts --}}
                    @can('view_contact')
                        <div class="tab-pane {{ old('tab') == 'contact' ? 'active' : null }}" id="contact" role="tabpanel"
                    ...
                    @can('update_contact_group')
                        ...
                        {{-- opt in out keywords --}}
                        <div class="tab-pane {{ old('tab') == 'opt_out_keywords' ? 'active' : null }}" id="opt_out_keywords"
                            role="tabpanel" aria-labelledby="opt_out_keywords-tab-justified">
    ...
    <script>
        $(document).ready(function() {
                ...
                columnDefs: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, full) {
                            return (
                                '<a href="' + full['conversion'] +
                                '" class="text-info me-1" data-bs-toggle="tooltip" data-bs-placement="top" title="' +
                                full['conversion_label'] + '">' +
                                feather.icons['message-square'].toSvg({
                                    class: 'font-medium-4'
                                }) +
                                '</a>' +
                                '<a href="' + full['send_sms'] +
                                '" class="text-success me-1" data-bs-toggle="tooltip" data-bs-placement="top" title="' +
                                full['send_sms_label'] + '">' +
            ...
            Table.delegate(".get_status", "click", function() {
                ...
                let url =
                    "{{ route('customer.contact.status', ['contact' => $contact->uid, 'id' => 'contact_id']) }}";
            ...
            Table.delegate(".action-delete", "click", function(e) {
                ...
                let contact_id = $(this).data('id');
                let url =
                    "{{ route('customer.contact.delete', ['contact' => $contact->uid, 'id' => 'contact_id']) }}";
            ...
            $(".add_opt_in_keyword").on('click', function(e) {
                ...
                let remainOptinKeywords = {!! $remain_opt_in_keywords !!},
                    options;
                $.each(remainOptinKeywords, function(key, value) {
                    options =
                        `${options}<option value="${value.keyword_name}">${value.keyword_name}</option>`;
                });
            ...
            $(".add_opt_out_keyword").on('click', function(e) {
                ...
                let remainOptOutKeywords = {!! $remain_opt_out_keywords !!},
                    options;
            ...
            Table.delegate(".action-delete-optin-keyword", "click", function(e) {
                ...
                let url =
                    "{{ route('customer.contacts.delete_optin_keyword', ['contact' => $contact->uid, 'id' => 'keyword_id']) }}";
            ...
            Table.delegate(".action-delete-optout-keyword", "click", function(e) {
                ...
                let keyword_id = $(this).data('id');
                let url =
                    "{{ route('customer.contacts.delete_optout_keyword', ['contact' => $contact->uid, 'id' => 'keyword_id']) }}";
