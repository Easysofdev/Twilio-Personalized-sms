                    ...
                    <div class="card-header">
                        <div>
                            <h2 class="fw-bolder mb-0">
                                {{ \App\Library\Tool::format_number(Auth::user()->customer->listsCount()) }}</h2>
            ...
            <div class="col-lg-3 col-sm-6 col-12">
                <div class="card">
                    <div class="card-header">
                        <div>
                            <h2 class="fw-bolder mb-0">
                                {{ \App\Library\Tool::format_number(Auth::user()->customer->subscriberCounts()) }}</h2>
                    ...
                    <div class="card-body">
                        ...
                        @else
                            <p class="mb-2 mt-1 font-medium-2">{!! __('locale.subscription.you_are_currently_subscribed_to_plan', [
                                ...
                                'price' => \App\Library\Tool::format_price(
                        ...
                        <div class="row border-top text-center mx-0">
                            <div class="col-6 border-end py-1">
                                ...
                                <h3 class="fw-bolder mb-0">
                                    {{ Auth::user()->customer->maxLists() == '∞' ? __('locale.labels.unlimited') : \App\Library\Tool::format_number(Auth::user()->customer->maxLists()) }}
                                </h3>
                            </div>
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-end">
                        <h4 class="card-title text-uppercase">
                            {{ __('locale.labels.outgoing_sms_history_of_current_month') }}</h4>
                    </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-end">
                        <h4 class="card-title text-uppercase">
                            {{ __('locale.labels.incoming_sms_history_of_current_month') }}</h4>
                    </div>
                    <div class="card-content">
                        <div class="card-body pb-0">
    ...
    @else
        <script>
            ...
            if (CustomerSendingQuota === '-1') {
                ...
                CustomerSendingQuota =
                    "{{ Auth::user()->customer->getSendingQuotaUsage() != 0 ? (Auth::user()->customer->getSendingQuotaUsage() / Auth::user()->customer->getSendingQuota()) * 100 : 0 }}"
            }
            ...
            if (CustomerMaxLists === '-1') {
                ...
                CustomerMaxLists =
                    "{{ Auth::user()->customer->listsCount() != 0 && Auth::user()->customer->getOption('list_max') != 0 ? (Auth::user()->customer->listsCount() / Auth::user()->customer->getOption('list_max')) * 100 : 0 }}"
            }
            ...
            if (CustomerMaxContacts === '-1') {
                ...
                CustomerMaxContacts =
                    "{{ Auth::user()->customer->subscriberCounts() != 0 && Auth::user()->customer->getOption('subscriber_max') != 0 ? (Auth::user()->customer->subscriberCounts() / Auth::user()->customer->getOption('subscriber_max')) * 100 : 0 }}"
            }
