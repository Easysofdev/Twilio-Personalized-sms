                ...
                <div class="card">
                    <div class="card-content">
                        <div class="card-body">
                            ...
                            <form class="form form-vertical" action="{{ route('customer.mms.quick_send') }}" method="post"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="mb-1">
                                            ...
                                            <small class="text-primary text-uppercase" id="remaining">160
                                                {{ __('locale.labels.characters_remaining') }}</small>
                                            <small class="text-primary text-uppercase pull-right" id="messages">1
