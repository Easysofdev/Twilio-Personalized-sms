                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-1">
                                            ...
                                            <input type="number" id="phone"
                                                ...
                                                required placeholder="{{ __('locale.labels.phone') }}"
                                                value="{{ old('phone') }}">
                                        ...
                                        <div class="col-12 mb-1">
                                            ...
                                            <input type="text" id="address"
                                                ...
                                                required placeholder="{{ __('locale.labels.address') }}"
                                                value="{{ old('address') }}">
                                            @error('address')
                                                <div class="invalid-feedback">
                                                    <strong>{{ $message }}</strong>
                                        ...
                                        <div class="col-12 mb-1">
                                            ...
                                            <input type="text" id="company"
                                                ...
                                                placeholder="{{ __('locale.labels.company') }}"
                                                value="{{ old('company') }}">
                                            @error('company')
                                                <div class="invalid-feedback">
                                                    <strong>{{ $message }}</strong>
            ...
            $(registerMultiStepsWizard)
                ...
                .each(function() {
                    $(this).on('click', function(e) {
                        ...
                        if (email != null && password != null && confirm_password != null && password ===
                            confirm_password) {
