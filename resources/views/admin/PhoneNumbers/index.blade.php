    ...
    <section id="datatables-basic">
        <div class="mb-3 mt-2">
            @can('view phone_numbers')
                <div class="btn-group">
                    ...
                    <div class="dropdown-menu" aria-labelledby="bulk_actions">
                        ...
                        <a class="dropdown-item bulk-available" href="#"><i data-feather="check"></i>
                            {{ __('locale.labels.available') }}</a>
            ...
            @can('create phone_numbers')
                <div class="btn-group">
                    <a href="{{ route('admin.phone-numbers.create') }}"
            ...
            @can('view phone_numbers')
                <div class="btn-group">
                    <a href="{{ route('admin.phone-numbers.export') }}" class="btn btn-info waves-light waves-effect fw-bold">
