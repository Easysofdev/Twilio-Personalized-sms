                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <div class="mb-1">
                                                ...
                                                <p><small
                                                        class="text-primary">{{ __('locale.payment_gateways.rename_name') }}</small>
                                                </p>
                                                @error('name')
                                                ...
                                                <div class="mb-1">
                                                    ...
                                                    <select class="form-control" name="environment" id="environment">
                                                        <option value="sandbox"
                                                            @if ($gateway->getOption('environment') == 'sandbox') selected @endif>
                                                            {{ __('locale.labels.sandbox') }}</option>
                                                        <option value="production"
                                                            @if ($gateway->getOption('environment') == 'production') selected @endif>
                                                            {{ __('locale.labels.production') }} </option>
                                                    </select>
                                                    @error('environment')
                                                        <div class="text-danger">
                                                            {{ $message }}
                                            ...
                                            <div class="col-12">
                                                <div class="mb-1">
                                                    ...
                                                    <input type="text" id="client_id" name="client_id"
                                                        class="form-control" value="{{ $gateway->getOption('client_id') }}"
                                                        required>
                                                    @error('client_id')
                                                        <div class="text-danger">
                                                            {{ $message }}
                                            ...
                                            <div class="col-12">
                                                <div class="mb-1">
                                                    ...
                                                    <input type="text" id="publishable_key" name="publishable_key"
                                                        class="form-control"
                                                        value="{{ $gateway->getOption('publishable_key') }}" required>
                                            ...
                                            <div class="col-12">
                                                <div class="mb-1">
                                                    ...
                                                    <input type="text" id="transaction_key" name="transaction_key"
                                                        class="form-control"
                                                        value="{{ $gateway->getOption('transaction_key') }}" required>
                                            ...
                                            <div class="col-12">
                                                <div class="mb-1">
                                                    ...
                                                    <input type="text" id="secret" name="merchant_secret"
                                                        class="form-control"
                                                        value="{{ $gateway->getOption('merchant_secret') }}" required>
                                            ...
                                            <div class="col-12">
                                                <div class="mb-1">
                                                    ...
                                                    <input type="text" id="secret" name="integration_key"
                                                        class="form-control"
                                                        value="{{ $gateway->getOption('integration_key') }}" required>
                                        ...
                                        @elseif($gateway->type == \App\Models\PaymentMethods::TYPE_INSTAMOJO)
                                            <div class="col-12">
                                                <div class="mb-1">
                                                    ...
                                                    <input type="text" id="secret" name="api_key"
                                                        class="form-control" value="{{ $gateway->getOption('api_key') }}"
                                                        required>
                                                    @error('api_key')
                                                        <div class="text-danger">
                                                            {{ $message }}
                                        ...
                                        @elseif($gateway->type == \App\Models\PaymentMethods::TYPE_RAZORPAY)
                                            ...
                                            <div class="col-12">
                                                <div class="mb-1">
                                                    ...
                                                    <input type="text" id="secret" name="key_id"
                                                        class="form-control" value="{{ $gateway->getOption('key_id') }}"
                                                        required>
                                                    @error('key_id')
                                                        <div class="text-danger">
                                                            {{ $message }}
                                        ...
                                        @elseif($gateway->type == \App\Models\PaymentMethods::TYPE_SSLCOMMERZ)
                                            ...
                                            <div class="col-12">
                                                <div class="mb-1">
                                                    ...
                                                    <input type="text" id="secret" name="store_id"
                                                        class="form-control"
                                            ...
                                            <div class="col-12">
                                                <div class="mb-1">
                                                    <label for="payment_details"
                                                        class="form-label required">{{ __('locale.labels.payment_details') }}</label>
                                        ...
                                        @else
                                            <div class="col-12">
                                                <p class="text-danger text-bold-600">
                                                    {{ __('locale.payment_gateways.not_found') }}</p>
                                            </div>
                                        @endif
